...
```
>>> from src.mbi import Dataset, Domain, FactoredInference
>>> import numpy as np
>>> 
...
This allows you to import modules from this package like ``` from src.mbi import FactoredInference ``` no matter what directory you are working in.  Once this is done, check to make sure the tests are passing
